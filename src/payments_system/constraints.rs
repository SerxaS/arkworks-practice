use crate::payments_system::common::*;
use crate::payments_system::{Root, SimplePath};
...
pub type SimplePathVar =
    PathVar<crate::payments_system::MerkleConfig, LeafHashGadget, TwoToOneHashGadget, ConstraintF>;
...
fn merkle_tree_constraints_correctness() {
    ...
    let tree = crate::payments_system::SimpleMerkleTree::new(
        &leaf_crh_params,
        &two_to_one_crh_params,
...
fn merkle_tree_constraints_soundness() {
    ...
    let second_tree = crate::payments_system::SimpleMerkleTree::new(
        &leaf_crh_params,
        &two_to_one_crh_params,
